...
echo "2. Clear dnsmasq"
echo "" >/etc/dnsmasq.d/portal.conf

# Clear all iptables rules
echo "3. Clearing all iptables rules..."
sudo iptables -F
...
echo "4. Clearing authenticated devices..."
...
echo "6. Restarting network interface..."
...
echo "7. Freeing up port 8181..."
sudo fuser -k 8181/tcp 2>/dev/null

# Clear logs
echo "8. Clearing logs..."
