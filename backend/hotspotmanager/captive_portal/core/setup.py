...
class CaptiveSetup:
    ...
    def add_default_rules(self) -> bool:
        ...
        try:
            ...
            subprocess.run(["iptables", "-P", "FORWARD", "DROP"], check=True)  # DROP, not ACCEPT
    ...
    def create_chains(self) -> bool:
        ...
        try:
            ...
            subprocess.run(["iptables", "-t", "nat", "-N", "AUTH_REDIRECT"], check=False)
    ...
    def add_portal_chain_rules(self) -> bool:
        ...
        try:
            ...
            # (inserted later by update_firewall script)
    ...
    def add_input_rules(self) -> bool:
        ...
        try:
            ...
            subprocess.run([
                "iptables", "-A", "INPUT", "-p", "tcp", "--dport", str(self.captive_port),
                "-j", "ACCEPT"
            ], check=True)
    ...
    def verify_setup(self) -> bool:
        ...
        try:
            ...
            checks.append(("FORWARD → CAPTIVE_PORTAL rule", has_critical_rule, "Must exist"))
        except Exception:
        ...
        try:
            ...
            has_http_redirect = "dpt:80" in result.stdout and "AUTH_REDIRECT" in result.stdout
            checks.append(("HTTP redirect rule", has_http_redirect, "Port 80 → AUTH_REDIRECT"))
        except Exception:
