...
export const StreamingPortalContainer = () => {
    ...
    */
        ...
        document.addEventListener('streaming-portal-create', handleStreamCreate);
        document.addEventListener('streaming-portal-update', handleStreamUpdate);
        document.addEventListener('streaming-portal-append', handleStreamAppend);
        document.addEventListener('streaming-portal-close', handleStreamClose);

        return () => {
            document.removeEventListener('streaming-portal-create', handleStreamCreate);
            document.removeEventListener('streaming-portal-update', handleStreamUpdate);
            document.removeEventListener('streaming-portal-append', handleStreamAppend);
            document.removeEventListener('streaming-portal-close', handleStreamClose);
        };
    }, []);
